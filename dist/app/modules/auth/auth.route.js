...
router.get("/google/callback", passport_1.default.authenticate("google", { failureRedirect: `${env_1.envVars.FRONTEND_URL}?error=There are some issues with your account.Please contact with our support team` }), auth_controller_1.AuthControllers.googleCallBackController);
